...
#include <WiFi.h>              // вместо ESP8266WiFi.h
...
// Button pins
#define BTN_UP    10   // GPIO10 - кнопка UP (D5)
#define BTN_DOWN  11   // GPIO11 - кнопка DOWN (D6)  
#define BTN_EXIT  12   // GPIO12 - кнопка EXIT (D7)

// I2C пины для OLED (обычно GPIO1 и GPIO2 для D1 и D2)
#define I2C_SDA   1    // GPIO1 - SDA (D1)
#define I2C_SCL   2    // GPIO2 - SCL (D2)
